...
import { User, Settings, LogOut, ChevronDown, Calendar, Mail } from 'lucide-react';
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className="flex items-center space-x-2 px-3 py-2 rounded-full border border-emerald-300 hover:shadow-md transition-all bg-gradient-to-r from-emerald-50 to-green-50"
      >
        <div className="w-8 h-8 rounded-full bg-gradient-to-r from-primary to-green-600 flex items-center justify-center text-white font-semibold text-sm">
          {getInitials()}
        </div>
      ...
      {/* Menu déroulant */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl shadow-lg border border-emerald-200 py-2 z-50">
          {/* Info utilisateur */}
